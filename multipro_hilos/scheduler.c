...
// Se crea un proceso de tipo void, en este se recibirán como datos de entrada
// los de la estructura PROCESS
...
// Se mantiene la forma de reserva de memoria con malloc
